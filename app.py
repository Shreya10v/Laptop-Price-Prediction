...
# Apple,Ultrabook,8,Mac,1.37,0,1,226.98300468106115,Intel Core i5,128,0,Intel
...
hybrid = st.selectbox('SSHD (Hybrid Storage)', [0, 508, 1000])
...
if st.button('Predict Price'):
    ...
    query = pd.DataFrame([[company, type, ram, os, weight,
                      touchscreen, ips, ppi, cpu, ssd, hybrid, gpu]], columns = ['Company', 'TypeName', 'Ram', 'OpSys', 'Weight', 'TouchScreen', 'IPS', 'PPI', 'Cpu_name', 'SSD', 'Hybrid', 'Gpu brand'])
